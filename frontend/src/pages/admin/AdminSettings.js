                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 bg-blue-50/50 border border-blue-100 rounded-2xl px-5 py-4 focus-within:border-blue-500 focus-within:bg-white transition-all group">
                      <svg viewBox="0 0 24 24" className="w-5 h-5 text-blue-500 group-focus-within:scale-110 transition-transform" fill="currentColor">
                        <path d="M24 12c0 6.627-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0s12 5.373 12 12zM12.43 8.858c-1.625.676-4.873 2.078-6.046 2.583-.608.243-.728.45-.71.62.043.395.42.593.993.774.573.181.821.229.98.232.181.003.35-.067.502-.176.417-.298 3.535-2.385 3.82-2.585.207-.14.401-.19.55-.067.149.124.128.36-.021.503-.173.167-1.465 1.385-2.077 1.954-.236.216-.401.373-.082.58 1.484 1.041 2.397 1.71 3.572 2.49.52.343.957.558 1.36.545.41-.013.791-.253.978-.71.492-1.222 1.4-4.225 1.581-5.698.008-.07-.01-.191-.108-.242-.1-.051-.237-.037-.301-.018-.119.034-2.04.832-3.341 1.374z"/>
                      </svg>
