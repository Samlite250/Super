    ...
    <div className="min-h-screen bg-[#F3F4F6] font-sans pb-20">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="bg-amber-50 border border-amber-200 p-6 rounded-[2rem] mb-10 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 text-amber-900 shadow-sm relative overflow-hidden z-20">
           <div className="absolute top-0 right-0 w-32 h-32 bg-amber-200/10 rounded-full blur-3xl"></div>
           ...
           <div className="text-center sm:text-left">
              ...
              <p className="text-[14px] font-bold leading-tight">Your request will be processed within <span className="text-amber-700">5 minutes to 24 hours</span>. If it exceeds this time, please contact Customer Support.</p>
           </div>
        </div>
